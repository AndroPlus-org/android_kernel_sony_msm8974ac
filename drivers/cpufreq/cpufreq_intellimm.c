...
#define DEF_POWER_SAVE_FREQUENCY		(1300000)
#define DEF_TWO_PHASE_FREQUENCY			(1900000)
#define DBS_INPUT_EVENT_MIN_FREQ		(1728000)
#define DEF_FREQUENCY_OPTIMAL			(1267200)
#define DEF_FREQ_DOWN_STEP			(550000)
#define DEF_FREQ_DOWN_STEP_BARRIER		(1267200)
#else
