 ...
 *	  so u have to set both to enable it. the possible temperature range is 30属C to 80属C (lower temps are making no sense and higher temps would reach
 ...
 *						   (0 to disable, values between 30 and 80 in 属C)
...
#define DEF_SCALING_BLOCK_TEMP				(0)	// ZZ: default cpu temperature threshold in 属C
#endif
...
#ifdef CONFIG_EXYNOS4_EXPORT_TEMP
// ZZ: tuneable scaling block temp -> possible values: 0 to disable, values from 30属C to 80属C, if not set default is 0
